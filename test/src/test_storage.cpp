...
{
    {
        ...
        EXPECT_FALSE(storage::is_equal(storage::storage(d1),
                                       storage::storage(d2)));
        EXPECT_TRUE(storage::is_equal(storage::storage(d1),
                                      storage::storage(d1)));
        EXPECT_TRUE(storage::is_equal(storage::storage(d2),
                                      storage::storage(d2)));
    }
...
{
    {
        ...
        EXPECT_FALSE(storage::is_same(storage::storage(d1),
                                      storage::storage(d2)));
        EXPECT_TRUE(storage::is_same(storage::storage(d1),
                                     storage::storage(d1)));
        EXPECT_TRUE(storage::is_same(storage::storage(d2),
                                     storage::storage(d2)));
    }
